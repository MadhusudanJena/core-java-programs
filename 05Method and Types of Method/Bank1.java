class BankAccount{
	...
	String accHName;
	double balance;
	public static void main(String[]args){ //Why should we create our own method,when we have main method already?
		                                                          //Because of its predefined syntax it is not reusable.
